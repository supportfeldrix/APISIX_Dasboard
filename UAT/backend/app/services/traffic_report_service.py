...
APISIX_PODS = ["apisix-uat-0", "apisix-uat-1"]

# Log file mapping by route pattern
# UAT uses string-based route IDs — grep matches partial strings in the log
LOG_FILES = {
    "realtimewsprovider-vendor-jwt": "realtime-screening.log",  # RTS - OAuth2 - Secure
    "rcm-injecting-jwt": "rcm-route.log",                      # RCM - OAuth2
    "rcm-no-jwt": "rcm-route.log",                             # RCM - Passthrough
    "realtimescreening-no-jwt": "realtime-screening.log",       # RTS - Passthrough
    "rts-no-jwt": "orchestrator-callback.log",                  # OrchestratorCallback - Passthrough
    "keycloak-external": "keycloak-access.log",                 # Keycloak External
    "keycloak-internal": "keycloak-access.log",                 # Keycloak Internal
    "keycloak-introspection": "keycloak-access.log",            # Keycloak Token Introspection
    "OIDC-Token": "keycloak-access.log",                        # OIDC Tokens
    "00000000000000000919": "realtime-screening.log",            # RTS - Heartbeat
    "actimize-webfront-redirect": "keycloak-access.log",        # Actimize Webfront Redirect
...
ROUTE_NAMES = {
    "realtimewsprovider-vendor-jwt": "RTS - OAuth2 - Secure",
    "rcm-injecting-jwt": "RCM - OAuth2",
    "rcm-no-jwt": "RCM - Passthrough",
    "realtimescreening-no-jwt": "RTS - Passthrough",
    "rts-no-jwt": "OrchestratorCallback - Passthrough",
    "keycloak-external": "Keycloak External",
    "keycloak-internal": "Keycloak Internal",
    "keycloak-introspection": "Keycloak Token Introspection",
    "OIDC-Token": "OIDC Tokens (Internal Keycloak)",
    "00000000000000000919": "RTS - Heartbeat",
    "actimize-webfront-redirect": "Actimize Webfront Redirect",
...
def get_traffic_report(
    ...
    # Yesterday/older: grep the full file for the route_id (streams only matching
    # lines over WebSocket rather than piping 100k raw lines through tail).
